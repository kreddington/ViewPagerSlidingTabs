...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onLoginFailed() {
        Toast.makeText(getBaseContext(), getString(R.string.msg_login_failed), Toast.LENGTH_LONG).show();
    ...
    public boolean validate() {
        ...
        // TODO:enter code to check for an account with that email and enter error_unregistered_email if no such account
