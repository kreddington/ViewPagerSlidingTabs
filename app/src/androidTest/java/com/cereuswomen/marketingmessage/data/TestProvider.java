...
public class TestProvider extends AndroidTestCase {
    ...
    public void testProviderRegistry() {
        ...
        try {
            ...
            assertEquals("Error: MessageProvider registered with authority: " + providerInfo.authority +
            ...
            assertTrue("Error: MessageProvider not registered at " + mContext.getPackageName(),
                    false);
        }
    }
    ...
    public void testGetType() {
        ...
        type = mContext.getContentResolver().getType(
                MessageEntry.buildMessageUri(testUserId));
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
        assertEquals("Error: the MessageEntry CONTENT_URI with location should return MessageEntry.CONTENT_TYPE",
                MessageEntry.CONTENT_TYPE, type);
    ...
    /*
        ...
        read out the data.  Uncomment this test to see if the basic message query functionality
        given in the ContentProvider is working correctly.
     */
    public void testBasicMessageQuery() {
        ...
        // Fantastic.  Now that we have a user, add some message data!
        ContentValues messageValues = TestUtilities.createMessageValues(userRowId);

        long messageRowId = db.insert(MessageEntry.TABLE_NAME, null, messageValues);
        ...
        TestUtilities.validateCursor("testBasicMessageQuery", messageCursor, messageValues);
    }

    /*
        This test uses the database directly to insert and then uses the ContentProvider to
        read out the data.  Uncomment this test to see if your user queries are
    ...
    public void testBasicUserQueries() {
        ...
        if ( Build.VERSION.SDK_INT >= 19 ) {
            assertEquals("Error: User Query did not properly set NotificationUri",
                    userCursor.getNotificationUri(), UserEntry.CONTENT_URI);
        }
    }
